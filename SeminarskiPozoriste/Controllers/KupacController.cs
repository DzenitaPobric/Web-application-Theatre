...
namespace SeminarskiPozoriste.web.Controllers
{
    public class KupacController : Controller
    {
        ...
        public IActionResult Obrisi(int id)
        {
            ...
            List<KupacNagradnaIgra> knList = db.KupacNagradnaIgra.Where(x => x.KupacID == id).ToList();
            foreach (var kn in knList)
            {
                db.KupacNagradnaIgra.Remove(kn);
            }
        ...
        public IActionResult UrediSnimi(KupacUrediVM model)
        {
                ...
                db.SaveChanges();
                db.Dispose();
                return RedirectToAction("Prikazi/" + model.KupacID);
            }
