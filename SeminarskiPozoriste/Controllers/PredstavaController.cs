...
namespace SeminarskiPozoriste.web.Controllers
{
    ...
    {       
        ...
        public IActionResult Obrisi(int id)
        {
            ...
            List<PredstavaUplata> pu= db.PredstavaUplata.Where(x => x.PredstavaID == p.PredstavaID).ToList();
        ...
        public IActionResult UrediSnimi(PredstavaUrediVM model)
        {
            ...
            db.SaveChanges();
            db.Dispose();
            return RedirectToAction("Prikazi/" + model.PredstavaID);
        }
